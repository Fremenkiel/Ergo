...
//     const col_inet_arr_value = ch_client.written_logs.items[0].columns.items[37].new_value;
...
//     const col_int2 = ch_client.written_logs.items[1].columns.items[0];
//     const col_int2_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_int4 = ch_client.written_logs.items[1].columns.items[0];
//     const col_int4_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_int8 = ch_client.written_logs.items[1].columns.items[0];
//     const col_int8_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_float4 = ch_client.written_logs.items[1].columns.items[0];
//     const col_float4_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_float8 = ch_client.written_logs.items[1].columns.items[0];
//     const col_float8_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_bool = ch_client.written_logs.items[1].columns.items[0];
//     const col_bool_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_text = ch_client.written_logs.items[1].columns.items[0];
//     const col_text_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_bytea = ch_client.written_logs.items[1].columns.items[0];
//     const col_bytea_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_enum = ch_client.written_logs.items[1].columns.items[0];
//     const col_enum_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_uuid = ch_client.written_logs.items[1].columns.items[0];
//     const col_uuid_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_numeric = ch_client.written_logs.items[1].columns.items[0];
//     const col_numeric_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_timestamp = ch_client.written_logs.items[1].columns.items[0];
//     const col_timestamp_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_json = ch_client.written_logs.items[1].columns.items[0];
//     const col_json_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_jsonb = ch_client.written_logs.items[1].columns.items[0];
//     const col_jsonb_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_char = ch_client.written_logs.items[1].columns.items[0];
//     const col_char_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_charn = ch_client.written_logs.items[1].columns.items[0];
//     const col_charn_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_timestamptz = ch_client.written_logs.items[1].columns.items[0];
//     const col_timestamptz_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_cidr = ch_client.written_logs.items[1].columns.items[0];
//     const col_cidr_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_inet = ch_client.written_logs.items[1].columns.items[0];
//     const col_inet_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_macaddr = ch_client.written_logs.items[1].columns.items[0];
//     const col_macaddr_arr = ch_client.written_logs.items[1].columns.items[0];
//     const col_macaddr8 = ch_client.written_logs.items[1].columns.items[0];
//     const col_macaddr8_arr = ch_client.written_logs.items[1].columns.items[0];
//
...
//     try testing.expectEqualStrings("col_int2_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_int4", col_int2.column_name);
//     try testing.expectEqualStrings("col_int4_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_int8", col_int2.column_name);
//     try testing.expectEqualStrings("col_int8_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_float4", col_int2.column_name);
//     try testing.expectEqualStrings("col_float4_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_float8", col_int2.column_name);
//     try testing.expectEqualStrings("col_float8_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_bool", col_int2.column_name);
//     try testing.expectEqualStrings("col_bool_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_text", col_int2.column_name);
//     try testing.expectEqualStrings("col_text_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_bytea", col_int2.column_name);
//     try testing.expectEqualStrings("col_bytea_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_enum", col_int2.column_name);
//     try testing.expectEqualStrings("col_enum_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_uuid", col_int2.column_name);
//     try testing.expectEqualStrings("col_uuid_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_numeric", col_int2.column_name);
//     try testing.expectEqualStrings("col_numeric_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_timestamp", col_int2.column_name);
//     try testing.expectEqualStrings("col_timestamp_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_json", col_int2.column_name);
//     try testing.expectEqualStrings("col_json_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_jsonb", col_int2.column_name);
//     try testing.expectEqualStrings("col_jsonb_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_char", col_int2.column_name);
//     try testing.expectEqualStrings("col_char_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_charn", col_int2.column_name);
//     try testing.expectEqualStrings("col_charn_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_timestamptz", col_int2.column_name);
//     try testing.expectEqualStrings("col_timestamptz_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_cidr", col_int2.column_name);
//     try testing.expectEqualStrings("col_cidr_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_inet", col_int2.column_name);
//     try testing.expectEqualStrings("col_inet_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_macaddr", col_int2.column_name);
//     try testing.expectEqualStrings("col_macaddr_arr", col_int2.column_name);
//     try testing.expectEqualStrings("col_macaddr8", col_int2.column_name);
//     try testing.expectEqualStrings("col_macaddr8_arr", col_int2.column_name);
//
...
//     columns.appendAssumeCapacity(.{ .has_changes = false, .old_value = try allocator.dupe(u8, "1"), .new_value = try allocator.dupe(u8, "1"), .column_name = try allocator.dupe(u8, "id"), .is_key = true });
//     columns.appendAssumeCapacity(.{ .has_changes = true, .old_value = try allocator.dupe(u8, "Googleplex"), .new_value = try allocator.dupe(u8, "1 Apple Park Way"), .column_name = try allocator.dupe(u8, "address_line_1"), .is_key = false });
//     columns.appendAssumeCapacity(.{ .has_changes = true, .old_value = try allocator.dupe(u8, ""), .new_value = try allocator.dupe(u8, ""), .column_name = try allocator.dupe(u8, "address_line_2"), .is_key = false });
//     columns.appendAssumeCapacity(.{ .has_changes = true, .old_value = try allocator.dupe(u8, "94043"), .new_value = try allocator.dupe(u8, "95014"), .column_name = try allocator.dupe(u8, "postal_code"), .is_key = false });
//     columns.appendAssumeCapacity(.{ .has_changes = true, .old_value = try allocator.dupe(u8, "Mountain View"), .new_value = try allocator.dupe(u8, "Cupertino"), .column_name = try allocator.dupe(u8, "city"), .is_key = false });
//     columns.appendAssumeCapacity(.{ .has_changes = true, .old_value = try allocator.dupe(u8, "US"), .new_value = try allocator.dupe(u8, "US"), .column_name = try allocator.dupe(u8, "country"), .is_key = false });
//
//     var res = [_]ReadResponse{
//         .{ 
//             .data = .{
